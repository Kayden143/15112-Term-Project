...
def drawInstructions(app, canvas):
    ...
    canvas.create_text(app.width//2, app.height//2 + app.menuMargin // 2, text = "Press w to skip a turn (enemies will move without you moving)", anchor = "center", font = "15")
    ...
    canvas.create_text(app.width//2, app.height//2 - app.menuMargin // 4, text = "Doing so will increase your depth and the difficulty of the enemies.", anchor = "center", font = "15")
